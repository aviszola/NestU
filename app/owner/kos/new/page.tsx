...
export default function CreateKosPage() {
  ...
  // combine DB facilities with defaults for display
    ...
    <OwnerShell activePage="properties">
        <main className="w-full px-margin-mobile md:px-margin-desktop py-stack-lg max-w-[1280px]">
          ...
          <div className="mb-stack-lg">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant mt-2">Lengkapi informasi properti Anda untuk mulai menarik penyewa potensial.</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-gutter">
              ...
              <div className="xl:col-span-8 space-y-stack-lg">
                ...
                {/* Progress */}
                <div className="bg-surface-container-lowest p-stack-md rounded-xl shadow-sm border border-outline-variant/30 flex justify-between items-center">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-primary text-on-primary flex items-center justify-center font-bold">1</div>
                    <div>
                      <p className="font-title-lg text-title-lg leading-none">Informasi Umum</p>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">Detail dasar properti Anda</p>
                    </div>
                  </div>
                  <div className="hidden md:block h-px flex-1 bg-outline-variant mx-8" />
                  <div className="hidden md:flex items-center gap-4 opacity-40">
                    <div className="w-10 h-10 rounded-full border-2 border-outline text-outline flex items-center justify-center font-bold">2</div>
                    <p className="font-title-lg text-title-lg leading-none">Media &amp; Fasilitas</p>
                  </div>
                </div>

                {/* Informasi Dasar */}
                <div className="bg-white p-stack-lg rounded-xl shadow-[0_4px_20px_rgba(30,58,138,0.05)] space-y-stack-md">
                  <h3 className="font-title-lg text-title-lg text-primary flex items-center gap-2">
                    <span className="material-symbols-outlined">info</span> Informasi Dasar
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-stack-md">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 rounded-lg border border-outline-variant bg-surface-container-low font-body-md text-body-md focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all outline-none"
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className="w-full pl-14 pr-4 py-3 rounded-lg border border-outline-variant bg-surface-container-low font-body-md text-body-md focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all outline-none"
                        />
                      </div>
                    </div>
                  </div>
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      required
                      rows={3}
                      className="w-full px-4 py-3 rounded-lg border border-outline-variant bg-surface-container-low font-body-md text-body-md focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all outline-none resize-none"
                    />
                  </div>
                  <div className="space-y-1">
                ...
                <div className="bg-white p-stack-lg rounded-xl shadow-[0_4px_20px_rgba(30,58,138,0.05)] space-y-stack-md">
                  <h3 className="font-title-lg text-title-lg text-primary flex items-center gap-2">
                    <span className="material-symbols-outlined">checklist</span> Fasilitas Kos
                  </h3>
                  <p className="font-body-sm text-body-sm text-on-surface-variant mb-4">Pilih fasilitas yang tersedia di properti Anda untuk mempermudah penyewa.</p>
                ...
                <div className="bg-white p-stack-lg rounded-xl shadow-[0_4px_20px_rgba(30,58,138,0.05)] space-y-stack-md">
                  <h3 className="font-title-lg text-title-lg text-primary flex items-center gap-2">
                    <span className="material-symbols-outlined">photo_library</span> Upload Foto Properti
                  </h3>
                  <label className="border-2 border-dashed border-outline-variant rounded-xl p-stack-lg bg-surface-container-low flex flex-col items-center justify-center text-center group hover:border-primary hover:bg-primary/5 transition-all cursor-pointer">
                ...
                <div className="bg-white p-stack-lg rounded-xl shadow-[0_4px_20px_rgba(30,58,138,0.05)] space-y-stack-md">
                  <h3 className="font-title-lg text-title-lg text-primary flex items-center gap-2">
                    <span className="material-symbols-outlined">description</span> Deskripsi Properti
                  </h3>
                  <div className="space-y-1">
                    ...
                    <div className="border border-outline-variant rounded-lg overflow-hidden">
                      ...
                      <textarea
                        ...
                        rows={6}
                        className="w-full px-4 py-3 bg-surface-container-low font-body-md text-body-md outline-none border-none resize-none"
                      />
                    </div>
                  </div>
                </div>
                ...
                {/* Actions */}
                <div className="flex flex-col sm:flex-row items-center gap-stack-md justify-end pt-stack-md">
                  <button
                    type="button"
                    onClick={() => router.back()}
                    className="w-full sm:w-auto px-10 py-3 rounded-lg border-2 border-primary text-primary font-bold hover:bg-primary/5 transition-all order-2 sm:order-1 font-label-md text-label-md"
                  >
                    Batal
                  </button>
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full sm:w-auto px-12 py-3 rounded-lg bg-primary text-on-primary font-bold shadow-lg hover:brightness-110 active:scale-95 transition-all order-1 sm:order-2 flex items-center justify-center gap-2 font-label-md text-label-md disabled:opacity-50"
                  >
                ...
                {error && (
                  <p className="bg-error-container/20 text-on-error-container p-3 rounded-lg font-body-sm text-body-sm">{error}</p>
                )}
              </div>
              ...
              <div className="xl:col-span-4 space-y-stack-lg">
                ...
                <div className="bg-white p-stack-lg rounded-xl shadow-sm border border-outline-variant/30">
